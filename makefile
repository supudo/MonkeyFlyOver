...
.PHONY gfx: makefile
	gfx2gba -t1 -D -fraw -ogfx/splashscreen -psplashscreen1.pal ./gfx/splashscreen1.bmp
	gfx2gba -t1 -D -fraw -ogfx/splashscreen -psplashscreen2.pal ./gfx/splashscreen2.bmp
	katie --output-asm-arm --output-h ./gfx/splashscreen/splashscreen.*
